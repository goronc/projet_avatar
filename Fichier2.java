...
public class Fichier2 {
    public static void main(String[] args) {
        ...
        reponses1.add("Chine");
        Question q1 = new Question("Quel est le plus grand pays du monde ?", reponses1, 1, 9, 4);
        ...
        reponses2.add("Ox");
        reponses2.add("O2");
        Question q2 = new Question("Quel est le symbole chimique de l'oxygène ?", reponses2, 1, 8, 2);
        ...
        Question q3 = new Question("Quelle est la capitale de l'Espagne ?", reponses3, 1, 7, 2);
        ...
        Question q4 = new Question("Quelle est la planète la plus éloignée du Soleil dans notre système solaire ?", reponses4, 1, 5, 8);
        ...
        reponses5.add("Tigre");
        reponses5.add("Ours");
        Question q5 = new Question("Quel est le plus grand félin ?", reponses5, 1, 6, 3);
        ...
        reponses6.add("Bleu");
        reponses6.add("Vert");
        Question q6 = new Question("Quelle est la couleur du soleil ?", reponses6, 1, 5, 1);
        ...
        Question q7 = new Question("Sur quel continent se trouve la France ?", reponses7, 1, 6, 3);
        ...
        Question q8 = new Question("Quel animal est surnommé le roi de la jungle ?", reponses8, 1, 3, 5);
        ...
        Question q9 = new Question("Quel est le langage de programmation le plus populaire ?", reponses9, 1, 8, 4);
        ...
        Question q10 = new Question("Quel est le seul animal capable de voler ?", reponses10, 1, 5, 1);
        ...
        Question q11 = new Question("Quel est le sport le plus populaire dans le monde ?", reponses11, 1, 8, 5);
        ...
        Question q12 = new Question("Quelle est la capitale de l'Italie ?", reponses12, 1, 6, 2);
        ...
        Question q13 = new Question("Quelle est la plus grande ville des États-Unis ?", reponses13, 1, 7, 3);
        ...
        Question q14 = new Question("Quelle est la langue officielle de l'Argentine ?", reponses14, 1, 4, 2);
        ...
        Question q15 = new Question("Quel est le plus gros animal terrestre ?", reponses15, 2, 6, 3);
        ...
        reponses16.add("Ruby");
        Question q16 = new Question("Quel est un langage de programmation orienté objet ?", reponses16, 1, 5, 2);
        ...
        Question q17 = new Question("Quel pays est connu pour le tango ?", reponses17, 2, 6, 3);
        ...
        Question q18 = new Question("Quel animal est souvent associé à la savane africaine ?", reponses18, 3, 5, 1);
        ...
        Question q19 = new Question("Quelle planète est connue pour ses anneaux ?", reponses19, 3, 8, 4);
        ...
        Question q20 = new Question("Quel sport est populaire aux États-Unis ?", reponses20, 2, 7, 3);
        ...
        Question q21 = new Question("Quelle est la couleur complémentaire du vert ?", reponses21, 1, 4, 2);
        ...
        Question q22 = new Question("Quel pays est réputé pour ses kangourous ?", reponses22, 1, 6, 3);
        ...
        Question q23 = new Question("Quel animal vit principalement dans l'océan ?", reponses23, 3, 5, 2);
        ...
        Question q24 = new Question("Quelle peinture célèbre a été réalisée par Vincent van Gogh ?", reponses24, 2, 7, 3);
        ...
        Question q25 = new Question("Quel pays a remporté la Coupe du Monde de football en 2018 ?", reponses25, 3, 7, 3);
        ...
        Question q26 = new Question("Quelle est la capitale de la Grèce ?", reponses26, 3, 4, 2);
        ...
        Question q27 = new Question("Quelle est la deuxième planète la plus proche du Soleil ?", reponses27, 2, 7, 3);
        ...
        reponses28.add("Golf");
        Question q28 = new Question("Quel sport se pratique avec une raquette ?", reponses28, 2, 5, 2);
        ...
        Question q29 = new Question("Quel pays est voisin de la France ?", reponses29, 1, 6, 3);
        ...
        Question q30 = new Question("Quel compositeur est connu pour sa Symphonie n°5 en ut mineur ?", reponses30, 1, 8, 4);
        ...
        reponses31.add("C++");
        Question q31 = new Question("Quel langage de programmation est souvent utilisé pour le développement d'applications Android ?", reponses31, 1, 7, 3);
        ...
        Question q32 = new Question("Quel artiste a peint la Joconde ?", reponses32, 3, 9, 4);
        ...
        Question q33 = new Question("Quelle est l'œuvre d'art célèbre peinte par Léonard de Vinci ?", reponses33, 1, 8, 4);
        ...
        Question q34 = new Question("Dans quel pays se trouve la Tour de Pise ?", reponses34, 2, 6, 3);
        ...
        Question q35 = new Question("Dans quel pays se trouve le Sphinx ?", reponses35, 1, 8, 4);
        ...
        Question q36 = new Question("Quel compositeur est connu pour sa Symphonie n°9 en ré mineur, également appelée 'Ode à la joie' ?", reponses36, 3, 10, 5);
        ...
        Question q37 = new Question("Quel est l'art de la scène qui met en jeu la voix, le geste et le jeu d'acteur ?", reponses37, 2, 7, 3);
        ...
        Question q38 = new Question("Quel site internet est connu pour être une plateforme de vente en ligne ?", reponses38, 1, 6, 3);
        ...
        Question q39 = new Question("Quel est l'animal terrestre le plus grand ?", reponses39, 3, 8, 4);
        ...
        Question q40 = new Question("Quel est le titre du roman écrit par Antoine de Saint-Exupéry ?", reponses40, 1, 7, 3);
        ...
        reponses41.add("Vert");
        reponses41.add("Bleu");
        Question q41 = new Question("Quelle est la couleur du ciel par temps clair ?", reponses41, 3, 4, 2);
        ...
        Question q42 = new Question("Quel sport se joue avec un ballon rond ?", reponses42, 2, 6, 3);
        ...
        reponses43.add("Chat");
        Question q43 = new Question("Quel animal miaule ?", reponses43, 3, 3, 1);
        ...
        Question q44 = new Question("Quel jour de la semaine vient après le mardi ?", reponses44, 3, 2, 1);
        ...
        reponses45.add("Rome");
        Question q45 = new Question("Quelle est la capitale de la France ?", reponses45, 1, 5, 2);
        ...
        Question q46 = new Question("Quel fruit est jaune ?", reponses46, 2, 4, 2);
        ...
        Question q47 = new Question("Quel instrument se joue en appuyant sur des touches ?", reponses47, 2, 6, 3);
        ...
        Question q48 = new Question("Quelle est la capitale du Japon ?", reponses48, 4, 5, 2);
        ...
        Question q49 = new Question("Quel sport se joue avec une batte et une balle ?", reponses49, 4, 7, 3);
